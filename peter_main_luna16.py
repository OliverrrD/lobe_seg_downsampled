...
out_classes = 6
img_dir = os.path.join('/local_directory/preproc_train')
label_dir = os.path.join('/local_directory/fixed_labels')

all_images = []
all_labels = []
for img_file in glob.glob(os.path.join(img_dir, "*.mhd")):
    label_file = os.path.join(label_dir, f"{os.path.basename(img_file)[:-4]}_LobeSegmentation.nrrd")
...
root_dir = os.path.join('/local_directory/luna16_0414/')
