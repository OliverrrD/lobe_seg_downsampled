...
from dataloader import infer_dataloader_binary
...
if __name__ == "__main__":
    ...
    infer_loader = infer_dataloader_binary(config, images)
    ...
    # grade_csv_path = "/local_directory/lobe_seg/infer_vlsp.csv"
