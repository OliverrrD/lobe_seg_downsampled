...
out_classes = 6
img_dir = os.path.join('/local_directory/train_preproc/')
label_dir = os.path.join('/local_directory/lvlsetsegCC/')
...
root_dir = os.path.join('/local_directory/unet512_0416')
