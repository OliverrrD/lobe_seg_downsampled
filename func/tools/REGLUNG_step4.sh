...
/home/local/VANDERBILT/gaor2/code/RNNLung/func/tools/linearBCVslow -F ${ref_image} -M ${move_image} -O ${tmp_dir}/linearBCV

echo 'Step 5: DeedsBCV non-rigid to reference'
/home/local/VANDERBILT/gaor2/code/RNNLung/func/tools/deedsBCVslow -F ${ref_image} -M ${move_image} -A ${tmp_dir}/linearBCV_matrix.txt -O ${final_dir}/${final_name}
