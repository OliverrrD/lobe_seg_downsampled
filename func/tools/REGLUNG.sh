...
/home/local/VANDERBILT/gaor2/anaconda3/envs/python37/bin/python /home/local/VANDERBILT/gaor2/code/RNNLung/func/tools/seg_lung.py --ori ${ref_image} --out ${tmp_dir}/ref_mask.nii.gz
/home/local/VANDERBILT/gaor2/anaconda3/envs/python37/bin/python /home/local/VANDERBILT/gaor2/code/RNNLung/func/tools/seg_lung.py --ori ${move_image} --out ${tmp_dir}/move_mask.nii.gz
/home/local/VANDERBILT/gaor2/anaconda3/envs/python37/bin/python /home/local/VANDERBILT/gaor2/code/RNNLung/func/tools/get_new_lung.py --ori ${ref_image} --mask ${tmp_dir}/ref_mask.nii.gz --out ${tmp_dir}/ref_seg.nii.gz
/home/local/VANDERBILT/gaor2/anaconda3/envs/python37/bin/python /home/local/VANDERBILT/gaor2/code/RNNLung/func/tools/get_new_lung.py --ori ${move_image} --mask ${tmp_dir}/move_mask.nii.gz --out ${tmp_dir}/move_seg.nii.gz
...
/home/local/VANDERBILT/gaor2/anaconda3/envs/python37/bin/python /home/local/VANDERBILT/gaor2/code/RNNLung/func/tools/padding.py --ori ${tmp_dir}/ref_resample.nii.gz --out ${tmp_dir}/ref_padding.nii.gz

/home/local/VANDERBILT/gaor2/anaconda3/envs/python37/bin/python /home/local/VANDERBILT/gaor2/code/RNNLung/func/tools/padding.py --ori ${tmp_dir}/move_resample.nii.gz --out ${tmp_dir}/move_padding.nii.gz

echo 'Step 4: LinearBCV affine to reference'
# /home/local/VANDERBILT/gaor2/code/RNNLung/func/tools/linearBCVslow
/home/local/VANDERBILT/gaor2/code/deedsBCV/linearBCV -F ${tmp_dir}/ref_padding.nii.gz -M ${tmp_dir}/move_padding.nii.gz -O ${tmp_dir}/linearBCV -l 1 -G 16 -L 16 -Q 5

echo 'Step 5: DeedsBCV non-rigid to reference'
/home/local/VANDERBILT/gaor2/code/deedsBCV/deedsBCV -F ${tmp_dir}/ref_padding.nii.gz -M ${tmp_dir}/move_padding.nii.gz -A ${tmp_dir}/linearBCV_matrix.txt -O ${final_dir}/${final_name} -l 1 -G 16 -L 16 -Q 5
