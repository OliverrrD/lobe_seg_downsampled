...
data_root = '/nfs/masi/MCL/xnat/MCL/3903794883_3903794883-20090422/3903794883_3903794883-20090422/2901-x-unknown/DICOM/'
subj_list = os.listdir(data_root)

dcm_list = glob(os.path.join(data_root, '*.dcm'))
...
data.to_csv('//nfs/masi/MCL/xnat/xnat20210330/upload.csv', index=False)