...
df = pd.read_csv('/media/gaor2/8e7f6ccf-3585-4815-856e-80ce8754c5b5/data/ThreeSet/proj_update.csv')
#df = df.loc[df['spore_bad'] == 0]
df = df.loc[df['lastitem'] == 1]
df0 = df.loc[df['phase'] == 0]
df1 = df.loc[df['phase'] == 1]
df2 = df.loc[df['phase'] == 2]
df3 = df.loc[df['phase'] == 3]
df4 = df.loc[df['phase'] == 4]
...
data_root = '/media/gaor2/8e7f6ccf-3585-4815-856e-80ce8754c5b5/saved_file/ThreeSet/v7_rep/proj/rnn/test_result'
df0 = pd.read_csv( data_root + '/epoch33_val0_CRNNClassifier.csv')
df1 = pd.read_csv(data_root + '/epoch40_val1_CRNNClassifier.csv')
df2 = pd.read_csv(data_root + '/epoch66_val2_CRNNClassifier.csv')
df3 = pd.read_csv(data_root + '/epoch12_val3_CRNNClassifier.csv')
df4 = pd.read_csv(data_root +  '/epoch29_val4_CRNNClassifier.csv')
...
data_root = '/media/gaor2/8e7f6ccf-3585-4815-856e-80ce8754c5b5/saved_file/ThreeSet/v7_rep/proj/cnn/test_result'
df0 = pd.read_csv( data_root + '/epoch0_val0_CNNNet.csv')
df1 = pd.read_csv(data_root + '/epoch99_val1_CNNNet.csv')
df2 = pd.read_csv(data_root + '/epoch1_val2_CNNNet.csv')
df3 = pd.read_csv(data_root + '/epoch6_val3_CNNNet.csv')
df4 = pd.read_csv(data_root +  '/epoch5_val4_CNNNet.csv')
...
data_root = '/media/gaor2/8e7f6ccf-3585-4815-856e-80ce8754c5b5/saved_file/ThreeSet/v7_rep/proj/drnn/test_result'
df0 = pd.read_csv( data_root + '/epoch54_val0_DisCRNNClassifier.csv')
df1 = pd.read_csv(data_root + '/epoch25_val1_DisCRNNClassifier.csv')
df2 = pd.read_csv(data_root + '/epoch20_val2_DisCRNNClassifier.csv')
df3 = pd.read_csv(data_root + '/epoch69_val3_DisCRNNClassifier.csv')
df4 = pd.read_csv(data_root + '/epoch18_val4_DisCRNNClassifier.csv')
...
data_root = '/media/gaor2/8e7f6ccf-3585-4815-856e-80ce8754c5b5/saved_file/ThreeSet/v7_rep/proj/trnn/test_result'
df0 = pd.read_csv( data_root + '/epoch22_val0_CTLSTM.csv')
df1 = pd.read_csv(data_root + '/epoch16_val1_CTLSTM.csv')
df2 = pd.read_csv(data_root + '/epoch66_val2_CTLSTM.csv')
df3 = pd.read_csv(data_root + '/epoch42_val3_CTLSTM.csv')
df4 = pd.read_csv(data_root + '/epoch21_val4_CTLSTM.csv')
...
plt.plot(kaggle_mean_fpr, kaggle_mean_tpr, color='b',
          label=r'Ori CNN [3]: %0.2f $\pm$ %0.2f' % (89.00, 1.65),
         lw=1, alpha=.8)
...
plt.plot(cnn_mean_fpr, cnn_mean_tpr, color='deeppink',
          label=r'MC-CNN: %0.2f $\pm$ %0.2f' % (90.85, 1.13),
         lw=1, alpha=.8)
...
plt.plot(rnn_mean_fpr, rnn_mean_tpr, color='cornflowerblue',
          label=r'LSTM [5,6]: %0.2f $\pm$ %0.2f' % (90.27, 1.15),
         lw=2, alpha=.8)
...
plt.plot(trnn_mean_fpr, trnn_mean_tpr, color='darkorange',
          label=r'tLSTM [11]: %0.2f $\pm$ %0.2f' % (91.06, 1.48),
         lw=1, alpha=.8)
...
plt.plot(drnn_mean_fpr, drnn_mean_tpr, color='aqua',
          label=r'DLSTM (ours): %0.2f $\pm$ %0.2f' % (91.17, 1.53),
         lw=1, alpha=.8)
